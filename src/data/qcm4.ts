...
export const qcm4: Question[] = [
  ...
  {
    id: 3,
    question: 'Sur une plage, où il n’y a pas de poste de secours',
    answers: {
  ...
  },
  {
    ...
    answers: {
      ...
      C: 'La limite de la zone de baignade',
  ...
  },
  {
    ...
    answers: {
      ...
      C: 'Faux, c’est le drapeau rouge qui doit être hissé',
  ...
  },
  {
    ...
    answers: {
      ...
      C: 'À la place du cône orange, on peut hisser un drapeau Rouge et Blanc',
  ...
  },
  {
    ...
    answers: {
      A: 'Surtout en présence de baines',
  ...
  },
  {
    ...
    answers: {
      ...
      B: 'Les emplacements où le public se baigne à ses risques et périls',
      C: 'Les emplacements aménagés qui font l’objet de dispositions particulières',
      D: 'A B C', // signifie "toutes les réponses ci-dessus"
    },
    correctAnswers: [],
  },
  {
    id: 11,
    question: 'Une baignade en eaux libres et d’accès payant',
    answers: {
  ...
  {
    id: 12,
    question: 'Une zone de bain en milieu naturel doit être balisée avec',
    answers: {
  ...
  },
  {
    ...
    answers: {
      A: 'Peut exercer en piscine toute l’année avec une dérogation du préfet',
  ...
  },
  {
    ...
    answers: {
      A: 'Le récépissé de déclaration de la préfecture',
      B: 'La formation continue en secourisme doit être à jour',
      // Note : les options C et D n'étaient pas lisibles dans le PDF fourni
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      ...
      // L'option D était mentionnée mais sans libellé clair
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      ...
      // Options B, C, D manquantes dans l'extrait
    },
    correctAnswers: [],
  },
  {
  ...
  },
  {
    ...
    answers: {
      ...
      C: "Par le Maire",
      D: "Par le Président d’une communauté de communes",
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      A: "Lorsqu’un conflit politique oppose le Maire et le Préfet",
      B: "Non car seul le Maire est responsable devant la justice",
      C: "Sur avis de la DDCSPP",
    },
    correctAnswers: [],
  },
  {
  ...
  },
  {
    ...
    answers: {
      A: "Toute la période estivale",
      B: "Le gérant doit uniquement informer ses clients de l’absence de surveillance",
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      ...
      D: "Jamais condamné car le client se baigne à ses risques et périls",
    },
    correctAnswers: [],
  },
  {
  ...
  },
  {
    ...
    answers: {
      ...
      B: "Doivent intervenir en mettant en œuvre les moyens dont ils disposent",
  ...
  },
  {
    ...
    answers: {
      ...
      B: "À pleine vitesse dès lors qu’il ne s’agit pas d’une zone de baignade",
  ...
  },
  {
    ...
    answers: {
      ...
      B: "Ne sont pas considérés comme des engins de plage",
  ...
  },
  {
    ...
    answers: {
      A: "Les paramètres de durée et de profondeur ne rentrent pas en ligne de compte",
      B: "Il est utile de préciser le nombre de plongeurs dans la palanquée",
      C: "L’administration d’oxygène est déconseillée",
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      ...
      B: "Lorsque vous êtes en présence d’un stade 2, la victime est inconsciente",
      C: "Des difficultés respiratoires avec une inconscience caractérisent le stade 3",
    },
    correctAnswers: [],
  },
  {
    ...
    answers: {
      A: "Il vaut mieux extraire la victime rapidement, même si elle est consciente",
