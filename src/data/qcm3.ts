...
export const qcm3: Question[] = [
  ...
  {
    id: 3,
    question: 'Lorsqu’aucun drapeau n’est hissé durant les heures de surveillance',
    answers: {
...

  {
    id: 18,
    question:
      'Le préfet maritime peut intervenir dans la zone des 300 mètres',
    answers: {
...

  {
    id: 37,
    question:
      'En milieu naturel, la surveillance des plages en métropole',
    answers: {
...

  {
    id: 38,
    question:
      'Le matériel de réanimation cardio-pulmonaire est composé',
    answers: {
